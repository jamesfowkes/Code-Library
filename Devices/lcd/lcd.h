...
{
	LCD_CONTROLLER_HD44780,
	LCD_CONTROLLER_KS0073
};
typedef enum lcd_controller_type LCD_CONTROLLER_TYPE;
...
typedef struct lcd_port_struct LCD_PORT;
...
typedef struct lcd_pin_struct LCD_PIN;

struct lcd_config_struct
{
	LCD_CONTROLLER_TYPE type;
	uint8_t lines;
	uint8_t dispLength;
...
typedef struct lcd_config_struct LCD_CONFIG;
...
/**
 ...
 @return  none
*/
extern void lcd_init(uint8_t dispAttr, LCD_PORT * pData, LCD_PORT * pDirection, LCD_PIN * pPins, LCD_CONFIG * pConfig);
